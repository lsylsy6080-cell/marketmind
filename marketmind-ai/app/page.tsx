    ...
    <MarketMindShell active="dashboard" updatedAt={updatedAt} workerUpdatedAt={workerUpdatedAt}>
      <div className="terminal terminal-v2">
        ...
        {latestDecision ? (
          ...
          <><LiveBitcoinChart entries={tradeEntries} exits={tradeExits} positions={dashboardData.openPositions} /><section className="panel empty-state"><div className="empty-mark"><img src="/marketmind-logo.svg" alt="" style={{width:"52px",height:"52px"}} /></div><h1>아직 생성된 AI 시장 판단이 없습니다.</h1><p>차트는 계속 표시되며, Market Worker 실행 후 AI 판단이 이 화면에 연결됩니다.</p></section></>
        )}

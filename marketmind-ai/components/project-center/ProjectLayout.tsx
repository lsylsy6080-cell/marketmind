...
const projectStats = [
  { label: "현재 릴리즈", value: "v2.2", description: "Git & Build Center" },
  { label: "운영 모드", value: "LIVE", description: "실시간 프로젝트 현황" },
  { label: "다음 목표", value: "v2.3", description: "AI Decision Monitor" },
];
    ...
    <main className={styles.projectCenter}>
      <section className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          <div>
            ...
            <p>
              시스템 상태, Git 커밋, 빌드와 배포 현황을 하나의 프로젝트
              운영센터에서 확인합니다.
            </p>
            <div className={styles.heroCommand}>
              <span aria-hidden="true">&gt;</span>
              <code>project-center --mode live --release v2.2</code>
            </div>
          </div>
      ...
      <section className={styles.focusSection} aria-labelledby="focus-title">
        <div className={styles.sectionHeading}>
          ...
          <p>
            Git과 배포 상태 연결 이후 AI Decision Engine 모니터로
            확장합니다.
          </p>
        </div>

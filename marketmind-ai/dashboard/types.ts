...
export type DashboardData = {
  ...
  latestFunding: FundingSnapshot | null;
  recentDecisions: FinalMarketDecision[];
  chartDecisions: FinalMarketDecision[];
  timelineDecisions: FinalMarketDecision[];
  recentBacktests: FinalMarketBacktest[];
